...
if ( isset( $trx ) && is_string( $trx ) ) {
	...
	<div class="gateway-banner bKash-hero-div bKash-success">
		...
		<p>Sender: <b>
		<?php
				esc_html_e( $trx['customerMsisdn'] ?? '', 'bkash-for-woocommerce' );
		?>
				</b></p>
		<p>
			Amount:
		...
		<ul>
			<li>
				...
				<strong>
				<?php
					esc_html_e( $trx['transactionType'] ?? '', 'bkash-for-woocommerce' );
				?>
					</strong>
			</li>
			<li>
				...
				<strong>
				<?php
					esc_html_e( $trx['organizationShortCode'] ?? '', 'bkash-for-woocommerce' );
				?>
					</strong>
			</li>
			<li>
				...
				<strong>
				<?php
					esc_html_e( $trx['initiationTime'] ?? '', 'bkash-for-woocommerce' );
				?>
					</strong>
			</li>
			<li>
